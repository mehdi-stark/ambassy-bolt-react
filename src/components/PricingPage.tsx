      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border rounded-xl p-8 flex flex-col h-full">
            ...
            <div className="mb-6">
              ...
              {typeof pricingData.ambassador.price[billingCycle] !==
                "string" && <span className="text-gray-500">{cycleText}</span>}
            </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-6">{pricingData.pro.description}</p>
            <div className="mb-6">
              <span className="text-4xl font-bold">
          ...
          <div className="border rounded-xl p-8 flex flex-col h-full">
            ...
            <p className="text-gray-600 mb-6">{pricingData.vip.description}</p>
            <div className="mb-6">
              <span className="text-4xl font-bold">
