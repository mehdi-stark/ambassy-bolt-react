  ...
  return (
    <div className="">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-xl font-semibold mb-2">Votre compte marque</h2>
          <p className="text-gray-600 mb-4">
            Ce compte représentera votre marque auprès des influenceurs
          </p>
          <input
            type="text"
            placeholder="Entrez votre compte instagram"
            className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
          />
          <p className="text-gray-600 mt-2">
            Instagram, YouTube, TikTok, Twitter ou Twitch ou{" "}
